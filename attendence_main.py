...
# import numpy as np
#
# video_capture = cv2.VideoCapture(0)  #jis web cam ko usse kr rahe uska number likhna hai maine abhi temproraliy 0 likha hai
#
# # Load known faces
...
#
# known_face_encoding = [harry_encoding, shreya_encoding]
# known_face_names = ["Harry", "Shreya"]
#
...
#
#     # Recognize faces
#     face_locations = face_locations.face_locations(rgb_small_frame)
#     face_encodings = face_locations.face_encodings(rgb_small_frame, face_locations)
#
...
# import numpy as np
#
# video_capture = cv2.VideoCapture(1)  # jis web cam ko usse kr rahe uska number likhna hai maine abhi temproraliy 0 likha hai
#
# # Load known faces
# harrys_image = face_recognition.load_image_file("faces/harry.jpeg")
# harry_encoding = face_recognition.face_encodings(harrys_image)[0]
